...
public class RdvService {
     ...
     public ArrayList<rdv> getListRdv() {
        ...
        ConnectionRequest con = new ConnectionRequest();
        String Url = "http://localhost/webservice/web/app_dev.php/Service/Publication/AjoutRES/"+ids+"/"+dat+"/"+nbplace+"/"+note;
        con.setUrl(Url);
        ...
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/webservice/web/app_dev.php/Service/Publication/ResShow/"+ids);
        con.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
                JSONParser jsonp = new JSONParser();
